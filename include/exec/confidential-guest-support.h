...
#define CONFIDENTIAL_GUEST_SUPPORT_CLASS(klass) \
    OBJECT_CLASS_CHECK(ConfidentialGuestSupportClass, (klass), TYPE_CONFIDENTIAL_GUEST_SUPPORT)
#define CONFIDENTIAL_GUEST_SUPPORT(obj) \
    OBJECT_CHECK(ConfidentialGuestSupport, (obj), TYPE_CONFIDENTIAL_GUEST_SUPPORT)
#define CONFIDENTIAL_GUEST_SUPPORT_GET_CLASS(obj) \
    OBJECT_GET_CLASS(ConfidentialGuestSupportClass, (obj), TYPE_CONFIDENTIAL_GUEST_SUPPORT)
